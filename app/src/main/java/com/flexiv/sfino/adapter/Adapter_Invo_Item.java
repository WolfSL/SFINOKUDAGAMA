...
public class Adapter_Invo_Item extends RecyclerView.Adapter<Adapter_Invo_Item.ViewsHolder> {

    private ArrayList<TBLT_SALINVDET> arr;
    private ArrayList<TBLT_SALINVDET> arr_full;
    ...
    public Adapter_Invo_Item(ArrayList<TBLT_SALINVDET> arr, Fragment_sub_batching context) {
        this.arr = arr;
    ...
    public void onBindViewHolder(@NonNull ViewsHolder holder, int position) {
        TBLT_SALINVDET item = arr.get(position);
        holder.item_batch.setText(item.getExpiryDate());
